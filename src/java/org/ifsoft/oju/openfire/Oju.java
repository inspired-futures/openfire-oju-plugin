...
public class Oju implements Plugin, PropertyEventListener, ProcessListener, MUCEventListener
{
    ...
    {
        return "https://" + XMPPServer.getInstance().getServerInfo().getHostname() + ":" + JiveGlobals.getProperty("httpbind.port.secure", "7443") + "/galene";
    }
    ...
    public static class OjuSocketCreator implements WebSocketCreator
    {
        @Override public Object createWebSocket(ServletUpgradeRequest req, ServletUpgradeResponse resp)
        {
            ...
            String ojuPort = JiveGlobals.getProperty("oju.port", getPort());
    ...
    {
        boolean ojuEnabled = JiveGlobals.getBooleanProperty("oju.enabled", true);
        ...
        if (ojuExePath != null && ojuEnabled)
        {
            ...
            ojuContext = new ServletContextHandler(null, "/galene", ServletContextHandler.SESSIONS);
            ojuContext.setClassLoader(this.getClass().getClassLoader());
            ServletHolder proxyServlet = new ServletHolder(ProxyServlet.Transparent.class);
            String ojuUrl = "http://" + JiveGlobals.getProperty("oju.ipaddr", getIpAddress()) + ":" + JiveGlobals.getProperty("oju.port", getPort());
            String turn = JiveGlobals.getProperty("oju.turn.ipaddr", getIpAddress()) + ":" + JiveGlobals.getProperty("oju.turn.port", "10014");
    ...
    {
        String iniFileName = ojuHomePath + "/data/passwd";
        List<String> lines = new ArrayList<String>();

        // create galene admin passwd file

        Log.info("Creating " + iniFileName);
        lines.add( JiveGlobals.getProperty("oju.username", "administrator") + ":" + JiveGlobals.getProperty("oju.password"));
    ...
    private void setupOjuFile(MUCRoom room)
    {
        ...
        for (JID jid : room.getOwners())
        {
            ...
            owner.put("password", properties.get("oju.owner.password"));
            op.put(op_kt++, owner);
        }
        ...
        for (JID jid : room.getAdmins())
        {
            ...
            admin.put("password", properties.get("oju.admin.password"));
    ...
    private void createAdminUser()
    {
        ...
        final String administrator = JiveGlobals.getProperty("oju.username", "administrator");
