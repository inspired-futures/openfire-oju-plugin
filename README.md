...
Oju will auto-create galene group files in `groups/groupname.json` from groupchat rooms.
...
You should be able to access Galène at `https://localhost:7443/galene`.  Connect
